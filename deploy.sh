...
READARR_URL=
READARR_API_KEY=
READARR_API_PREFIX=/api/v1
READARR_METADATA_PROFILE_ID_EPUB=
READARR_METADATA_PROFILE_ID_PDF=
READARR_METADATA_PROFILE_ID_MOBI=
READARR_METADATA_PROFILE_ID_AUDIOBOOK=
